...
# 1. Execute the necessary action on the node.
# 2. Go to the left node, and perform a recursive preorder traversal.
# 3. Go to the right node, and perform a recursive preorder traversal.
...
if __name__ == "__main__":
    ...
    insert_data(root, 52)
    insert_data(root, 78)
    print("Preorder Traversal: ", inorder_tree_traversal(root))